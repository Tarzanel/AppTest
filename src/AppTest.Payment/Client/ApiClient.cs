...
namespace AppTest.Payment.Client
{
    ...
    public partial class ApiClient
    {
        ...
        public ApiClient()
        {
            Configuration = AppTest.Payment.Client.Configuration.Default;
            RestClient = new RestClient("https://staging.ptranz.com/api/");
            RestClient.IgnoreResponseStatusCode = true;
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://staging.ptranz.com/api/).
        /// </summary>
        /// <param name="config">An instance of Configuration.</param>
        public ApiClient(Configuration config)
        {
            Configuration = config ?? AppTest.Payment.Client.Configuration.Default;
        ...
        public ApiClient(String basePath = "https://staging.ptranz.com/api/")
        {
