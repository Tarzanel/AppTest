...
namespace AppTest.Payment.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CaptureResponse :  IEquatable<CaptureResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CaptureResponse" /> class.
        /// </summary>
        /// <param name="originalTrxnIdentifier">Transaction Identifier of the original transaction (transaction being captured).</param>
        ...
        /// </summary>
        /// <value>Transaction Identifier of the original transaction (transaction being captured)</value>
        ...
        {
            return this.Equals(input as CaptureResponse);
        }

        /// <summary>
        /// Returns true if CaptureResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CaptureResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CaptureResponse input)
        {
            if (input == null)
                return false;
