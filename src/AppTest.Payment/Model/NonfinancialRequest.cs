...
namespace AppTest.Payment.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class NonfinancialRequest :  IEquatable<NonfinancialRequest>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NonfinancialRequest" /> class.
        /// </summary>
        /// <param name="tokenize">If true, tokenizes and returns the tokenized PAN.</param>
        ...
        public NonfinancialRequest(bool? tokenize = default(bool?), string transactionIdentifier = default(string), double? totalAmount = default(double?), double? tipAmount = default(double?), double? taxAmount = default(double?), double? otherAmount = default(double?), string currencyCode = default(string), string localTime = default(string), string localDate = default(string), bool? addressVerification = default(bool?), bool? threeDSecure = default(bool?), bool? binCheck = default(bool?), bool? fraudCheck = default(bool?), bool? recurringInitial = default(bool?), bool? recurring = default(bool?), bool? cardOnFile = default(bool?), bool? accountVerification = default(bool?), Source source = default(Source), string terminalId = default(string), string terminalCode = default(string), string terminalSerialNumber = default(string), string externalIdentifier = default(string), string externalBatchIdentifier = default(string), string externalGroupIdentifier = default(string), string orderIdentifier = default(string), Address billingAddress = default(Address), Address shippingAddress = default(Address), bool? addressMatch = false, ExtendedRequestData extendedData = default(ExtendedRequestData))
        {
            ...
            {
                throw new InvalidDataException("currencyCode is a required property for NonfinancialRequest and cannot be null");
            }
            else
            {
            ...
            if (source == null)
            {
                throw new InvalidDataException("source is a required property for NonfinancialRequest and cannot be null");
            }
            else
            {
                this.Source = source;
        ...
        /// </summary>
        /// <value>If true, tokenizes and returns the tokenized PAN</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NonfinancialRequest {\n");
        ...
        {
            return this.Equals(input as NonfinancialRequest);
        }

        /// <summary>
        /// Returns true if NonfinancialRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NonfinancialRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NonfinancialRequest input)
        {
            if (input == null)
                return false;
