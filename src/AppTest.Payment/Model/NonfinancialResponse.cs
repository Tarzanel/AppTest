...
{
    /// <summary>
    /// Nonfinancial response (for Risk Management for example)
    /// </summary>
    [DataContract]
        public partial class NonfinancialResponse :  IEquatable<NonfinancialResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NonfinancialResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NonfinancialResponse {\n");
        ...
        {
            return this.Equals(input as NonfinancialResponse);
        }

        /// <summary>
        /// Returns true if NonfinancialResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of NonfinancialResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NonfinancialResponse input)
        {
            if (input == null)
                return false;
