...
namespace AppTest.Payment.Model
{
        ...
        public partial class Transaction :  IEquatable<Transaction>
    {
        ...
        public Transaction(string authorizationCode = default(string), string avsResponseCode = default(string), string customData = default(string), string cvvResponseCode = default(string), string externalBatchIdentifier = default(string), string externalGroupIdentifier = default(string), string externalIdentifier = default(string), string internalResultCode = default(string), string isoResponseCode = default(string), double? otherAmount = default(double?), double? taxAmount = default(double?), double? tipAmount = default(double?), double? totalAmount = default(double?), DateTime? transactionDateTime = default(DateTime?), Guid? transactionIdentifier = default(Guid?), int? transactionType = default(int?))
        {
