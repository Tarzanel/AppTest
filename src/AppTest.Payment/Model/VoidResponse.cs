...
namespace AppTest.Payment.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class VoidResponse :  IEquatable<VoidResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="VoidResponse" /> class.
        /// </summary>
        /// <param name="originalTrxnIdentifier">Transaction Identifier of the original transaction (transaction being voided or auto-reversed).</param>
        ...
        /// <summary>
        /// Transaction Identifier of the original transaction (transaction being voided or auto-reversed)
        /// </summary>
        /// <value>Transaction Identifier of the original transaction (transaction being voided or auto-reversed)</value>
        ...
        {
            return this.Equals(input as VoidResponse);
        }

        /// <summary>
        /// Returns true if VoidResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of VoidResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(VoidResponse input)
        {
            if (input == null)
                return false;
